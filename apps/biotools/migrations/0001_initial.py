        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Tool description from bio.tools."
                    ),
                ),
                (
                    "homepage",
                    models.URLField(
                        blank=True, help_text="Tool homepage URL from bio.tools."
                    ),
                ),
                (
                    "version",
                ...
                (
                    "tool_type",
                    models.JSONField(
                        default=list, help_text="List of bio.tools toolType values."
                    ),
                ),
                (
                    "operating_system",
                ...
                (
                    "documentation",
                    models.JSONField(
                        default=list, help_text="Documentation links from bio.tools."
                    ),
                ),
                (
                    "download",
                    models.JSONField(
                        default=list, help_text="Download links from bio.tools."
                    ),
                ),
                (
                    "links",
                    models.JSONField(
                        default=list, help_text="Other links from bio.tools."
                    ),
                ),
                (
                    "edam_topic_uris",
                    models.JSONField(
                        default=list,
                        help_text="List of EDAM topic URIs from bio.tools.",
                    ),
                ),
                (
                    "raw_json",
